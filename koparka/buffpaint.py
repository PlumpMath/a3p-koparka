...
class BufferPainter ():
    ...
    def addCanvas(self, size=512, default_tex='data/black.png', brush_shader=None, shader_inputs=None):
        ...
        self.images.append(PNMImage(size, size,4))
        self.images[-1].read(default_tex)
        self.roots.append(NodePath("bufferRender"+id))        
        self.textures.append(Texture())
        self.textures[-1].setWrapU(Texture.WM_clamp)
        self.textures[-1].setWrapV(Texture.WM_clamp)
